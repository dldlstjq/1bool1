    ...
    <Section>
      ...
      <ThemeProvider theme={theme}>
        <Container component='main' maxWidth='xs'>
          ...
          >
            <img src={require('../../common/logo.png')} alt='우리로고'></img>
            ...
            <Box component='form' noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={10}>
                  ...
                  />
                  {isNaN(age) && (
                    <span className={`message ${isAge ? 'success' : 'error'}`}>{ageMessage}</span>
                  )}
                </Grid>
                <Grid item xs={1}></Grid>
              ...
              <Grid item md={10}>
                <Button type='submit' variant='contained' sx={{ mt: 2, mb: 3, ml: 18 }}>
                  회원가입
                </Button>
              </Grid>
            ...
            <Grid container spacing={2} columns={16} sx={{ ml: 15 }}>
              <Grid item xs={6} md={8}>
                <span> 계정이 있으신가요?</span>
              </Grid>
              <Grid item xs={6} md={4}>
