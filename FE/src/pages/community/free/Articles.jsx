...
function Articles() {
  ...
  return (
    <>
      ...
      <div className='p-1 sm:p-0 sm:w-11/12 md:w-3/4 lg:w-2/3 mx-auto' onClick={handleClick}>
        {/* <h1 className='title text-4xl lg:text-6xl my-5 md:mb-20 ml-1'>자유게시판</h1> */}
        <Box style={{ display: 'flex', flexDirection: 'row', marginTop: '2rem' }}>
          <Typography
            variant='h4'
            style={{
              fontWeight: 'bold',
        ...
        <div className='border-t-2 border-slate-700'>
          {articles.slice(20 * (page - 1), 20 * (page - 1) + 20).map((data, idx) => {
